...
public class KafkaTopicHealthIndicatorDownTest {
    ...
    public void doHealthCheck() throws Exception {
        KafkaHealthIndicatorAutoConfiguration.KafkaClientHealthIndicator indicator = new KafkaHealthIndicatorAutoConfiguration.KafkaClientHealthIndicator(this.properties);
