 ...
 */
package com.ydespreaux.shared.data.elasticsearch.repository.config;
...
import com.ydespreaux.shared.data.elasticsearch.repository.support.ElasticsearchRepositoryFactoryBean;
...
public class ElasticsearchRepositoryConfigExtension extends RepositoryConfigurationExtensionSupport {
	...
	*/
	...
	protected Collection<Class<?>> getIdentifyingTypes() {
		return Collections.singletonList(ElasticsearchRepository.class);
	}
}
